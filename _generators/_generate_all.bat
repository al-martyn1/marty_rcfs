...
umba-enum-gen --namespace=marty_rcfs --enum-flags=0 %DECLCLS% %FLAGS% %HEX8% %UINT32% -E=FileAttrs -F=FileAttrsDefault=0;Directory,FlagDirectory=1;DirectoryAttrsDefault=1 ..\rcfs_flags.h
